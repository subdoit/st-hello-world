...
def load_model():
    ...
    pipe = StableDiffusionPipeline.from_pretrained(model_id, torch_dtype=torch.float32, scheduler=euler_scheduler, safety_checker=None) # float 16 for GPU, 32 for CPU
    pipe = pipe.to("cpu") # Cuda for GPU, or CPU
